...
if ($acao === 'novo') { include 'admin_usuarios_novo.php'; exit; }
if ($acao === 'editar') { include 'admin_usuarios_editar.php'; exit; }
...
<head>
    ...
    <title>Gerenciar Usuários - Impacto Verde</title>
...
<body>
    ...
    <main class="container py-4">
        ...
        <div class="dashboard-header">
            ...
            <div>
                <a href="admin_usuarios.php?acao=novo" class="btn btn-lg">
        ...
        <div class="perfil-card">
            <div class="alert alert-info">
                ...
                <strong>Como funciona:</strong> Apenas o administrador pode criar usuários. 
                Após criar, envie o e-mail e senha para o usuário acessar o sistema.
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(!empty($u['foto']) && file_exists($u['foto'])): ?>
                                    <img src="<?= htmlspecialchars($u['foto']) ?>" 
                                         alt="<?= htmlspecialchars($u['nome']) ?>"
                                         style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover; border: 2px solid var(--verde-medio);">
                                <?php else: ?>
                                    <div style="width: 40px; height: 40px; border-radius: 50%; background: var(--verde-medio); display: flex; align-items: center; justify-content: center; color: white; font-weight: 600;">
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="admin_usuarios.php?acao=editar&id=<?= $u['id'] ?>" 
                                       class="btn btn-sm btn-outline" 
                                       title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <?php if($u['id'] != $_SESSION['usuario_id']): ?>
                                    <a href="admin_usuarios_excluir.php?id=<?= $u['id'] ?>" 
                                       class="btn btn-sm btn-danger" 
                                       onclick="return confirm('Tem certeza que deseja excluir este usuário? Todas as notícias dele também serão excluídas.')"
                                       title="Excluir">
            ...
            <div class="text-center py-5">
                ...
                <p class="text-muted">Seja o primeiro a cadastrar um usuário!</p>
                <a href="admin_usuarios.php?acao=novo" class="btn btn-lg mt-3">
